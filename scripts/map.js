...
$(function() {
	...
	var cloudantViews = [];
	$.getJSON('https://christianhung.cloudant.com/testing0303/_design/tour/',
		function(result) {
...
function getLayer(callback, cloudantView) {
	var cloudantURLbase =
		"https://christianhung.cloudant.com/testing0303/_design/tour/_view/";
...
function searchPoints(callback, cloudantSearch) {
	var cloudantURLbase =
		"https://christianhung.cloudant.com/testing0303/_design/tour/_search/ids?q=";
	var cloudantURLcallback = "&callback=?";
